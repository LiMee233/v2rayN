    ...
    public partial class MainWindow
    {
        ...
        public MainWindow()
        {
            ...
            this.WhenActivated(disposables =>
            {
                ...
                this.OneWayBind(ViewModel, vm => vm.BlRouting, v => v.cmbRoutings.Visibility).DisposeWith(disposables);
                ...
                this.Bind(ViewModel, vm => vm.EnableTun, v => v.togEnableTun.IsOn).DisposeWith(disposables);
                ...
                //UI
                this.Bind(ViewModel, vm => vm.ColorModeDark, v => v.togDarkMode.IsOn).DisposeWith(disposables);
                this.Bind(ViewModel, vm => vm.FollowSystemTheme, v => v.followSystemTheme.IsOn).DisposeWith(disposables);
